...
\restrict NW7CgfoJekTRcQjj4PtlmY1G4IUa7DLYQAU1s8xOBUqmo7SjluNz4tEFALveanl
...
CREATE INDEX kirtan_titles_browse_visible_normalized_idx ON public.kirtan_titles USING gin (normalized_title extensions.gin_trgm_ops) WHERE (is_browse_visible = true);
...
CREATE INDEX kirtan_titles_searchable_normalized_idx ON public.kirtan_titles USING gin (normalized_title extensions.gin_trgm_ops) WHERE (is_searchable = true);
...
\unrestrict NW7CgfoJekTRcQjj4PtlmY1G4IUa7DLYQAU1s8xOBUqmo7SjluNz4tEFALveanl
