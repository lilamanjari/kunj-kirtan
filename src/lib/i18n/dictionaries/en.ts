...
export const enDictionary: AppDictionary = {
  common: {
    ...
    offlineFavorites: "Offline favorites",
    offlineFavoritesEnabled: "Offline favorites are on",
    offlineFavoritesDisabled: "Offline favorites are off",
  ...
  explore: {
    ...
    durationAnyLength: "Any length",
    durationUnder10: "Under 10 min",
    duration10To20: "10-20 min",
    duration20To30: "20-30 min",
    durationOver30: "Over 30 min",
    mahaMantrasCount: "{count} Maha Mantras",
  },
  home: {
    currentVrata: "Current Vrata",
    currentVrataSubtitle: "A sacred period with its own kirtans and moods.",
    currentVrataEndsIn: "Ends in {days} days",
    currentVrataEndsToday: "Ends today",
  ...
  actions: {
    ...
    addToOffline: "Download for offline",
    removeFromOffline: "Remove offline download",
