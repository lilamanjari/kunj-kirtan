...
export const ruDictionary: AppDictionary = {
  common: {
    ...
    offlineFavorites: "Офлайн-избранное",
    offlineFavoritesEnabled: "Офлайн-избранное включено",
    offlineFavoritesDisabled: "Офлайн-избранное выключено",
  ...
  actions: {
    ...
    addToOffline: "Скачать для офлайна",
    removeFromOffline: "Удалить офлайн-файл",
